...
export const changelog = [
    {
        ...
        added: [
            ...
            "The project switcher now shows an amber count on each project with agent work waiting on you — pending triage questions and unopened generated drafts — updating live so you notice it without opening the project.",
        ],
    },
    {
        version: '1.1',
