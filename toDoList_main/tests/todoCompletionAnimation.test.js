...
// applies to the project view `#mainList` rows (`#toDoChild`), covered
// by a single CSS rule. Done → open and prefers-reduced-motion users
// skip the animation entirely; the data mutation always fires
// synchronously.
...
describe('todo completion slide-out fade animation — CSS surface', () => {
    ...
    it('binds the keyframes to .todoCompleting with a ~280ms duration', () => {
        // The project view #toDoChild row carries the animation rule.
