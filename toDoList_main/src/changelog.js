...
export const changelog = [
    {
        ...
        added: [
            ...
            "Tasks in the TODO.md viewer that carry an id now show a Run this entry button that dispatches the automation routine against just that one task and tracks it in the header status pill.",
        ],
        changed: [
