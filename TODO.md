...
- [x] **[MEDIUM]** Pin sideTit and addProj while sideMa scrolls when projects overflow
...
- [x] **[MEDIUM]** Replace inline VIEW and APPEARANCE sections with a single Settings modal
