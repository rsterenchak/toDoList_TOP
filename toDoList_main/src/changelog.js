...
export const changelog = [
    {
        ...
        fixed: [
            ...
            'Open-task count badges now appear on every sidebar project row, and the title bar above the task list was removed so the panel starts directly with the add-task input.',
        ],
    },
];
