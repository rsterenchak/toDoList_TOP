...
// view-switcher pills (PROJECTS / AGENT) and the visible main pane below
...
//   • ArrowDown from a pill drops focus into the visible main pane's first
//     focusable element (placeholder #toDoInput in PROJECTS).
...
describe('view-pill arrow-key navigation into and out of the main pane', () => {
    ...
    it('the pill drop-in handler stops propagation so the document arrow handler does not also fire', () => {
        ...
        // rows even in AGENT view where mainList is hidden).
    ...
    it('the pill drop-in handler picks its target from the active view', () => {
        ...
        // focus on a hidden node when AGENT is the active view.
